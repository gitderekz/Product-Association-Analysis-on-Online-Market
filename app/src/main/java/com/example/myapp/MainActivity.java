...
//        });
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isImageAdded!=false && imageName!=null && item_id!=null && item_count!=null && category!=null && category!="")
                {
//                    category = imageCategory.getText().toString();
    ...
    private void uploadImage(final String imageName,final String price,final String description,String item_id,String item_count) {
